...
internal sealed class OpenTelemetrySdkEventSource : EventSource, IConfigurationExtensionsLogger
{
    ...
    [Event(58, Message = "Declarative config: trace_id_ratio_based sampler ratio '{0}' is invalid or out of range [0, 1]; using default value of 1.0.", Level = EventLevel.Warning)]
    public void TraceIdRatioBasedSamplerRatioInvalid(string configValue)
        => this.WriteEvent(58, configValue);
