...
/// <see cref="BaseProcessor{Activity}"/> instances from a declarative
...
/// custom processor to the declarative configuration registry. Register the provider
/// with <c>services.AddSpanProcessorPluginProvider(provider)</c>.
/// </remarks>
...
public abstract class SpanProcessorPluginProvider : PluginComponentProvider<BaseProcessor<Activity>>
{
}
